...
export default function ChatContainer(){
    ...
    <>
        ...
        >
            ...
            <Image src={chatIcon} alt="" className="w-1/2 h-1/2 dark:invert" />
        </div>
        ...
        <div className={`
            ...
            sm:rounded-s-lg bg-blue-700 transition-transform duration-500 overflow-y-auto ${!isShown ? "translate-x-full" : "translate-x-0"}`}
        >
            <div className="w-10 aspect-square bg-red-700 rounded-lg right-1 top-1 cursor-pointer flex justify-center items-center font-bold text-xl" onClick={()=>setIsShown(false)}>X</div>
            <Chat />
        </div>
    </>
    );
